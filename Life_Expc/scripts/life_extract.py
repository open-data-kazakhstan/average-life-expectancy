...
xlsx_file_path = r"C:\Users\USER\Desktop\Life_Project\Life_Expc\data\llife.xlsx"

# Specify the path where you want to save the CSV file
csv_file_path = r'C:\Users\USER\Desktop\Life_Project\Life_Expc\data\llife.csv'
