...
# Read kazpop.csv
data = pd.read_csv(r'C:\Users\USER\Desktop\Life_Project\Life_Expc\data\life_X_piv.csv')
...
for area, area_data in grouped_data:
    ...
    y = area_data['Ожидаемый возраст населения при рождении'].values
...
predictions_df = predictions_df.melt(id_vars='Год', var_name='Регион', value_name='Ожидаемый возраст населения при рождении')
...
df_sorted.to_csv(r'C:\Users\USER\Desktop\Life_Project\Life_Expc\data\life_X_fin.csv')