...
file = r'C:\Users\USER\Desktop\Life_Project\Hosp_Amount\data\Hosp_anim.csv'
df = pd.read_csv(file)
print(df)
...
def animate(rank):
    ...
    plot = plt.barh(y=filt_areas['Регион'], width=filt_areas['Число больничных органзаций'], color='#E6825D')
    ...
    ax.set_title(f'Число больничных организаций по Регионам на {year} год c прогнозом  ', size=18, weight='bold')
