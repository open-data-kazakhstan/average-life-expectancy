...
# Read kazpop.csv
data = pd.read_csv(r'C:\Users\USER\Desktop\Life_Project\Hosp_Amount\data\Hosp_piv.csv')
...
for area, area_data in grouped_data:
    ...
    y = area_data['Число больничных органзаций'].values
...
predictions_df = predictions_df.melt(id_vars='Год', var_name='Регион', value_name='Число больничных органзаций')
...
df_sorted.to_csv(r'C:\Users\USER\Desktop\Life_Project\Hosp_Amount\data\Hosp_fin.csv')